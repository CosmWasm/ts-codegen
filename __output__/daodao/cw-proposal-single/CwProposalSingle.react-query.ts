...
export interface CwProposalSingleInfoQuery extends CwProposalSingleReactQuery<InfoResponse, TData> {}
...
export interface CwProposalSingleVoteHooksQuery extends CwProposalSingleReactQuery<VoteHooksResponse, TData> {}
...
export interface CwProposalSingleProposalHooksQuery extends CwProposalSingleReactQuery<ProposalHooksResponse, TData> {}
...
export interface CwProposalSingleListVotesQuery extends CwProposalSingleReactQuery<ListVotesResponse, TData> {
  args: {
    limit?: number;
    proposalId: number;
    startAfter?: string;
...
export interface CwProposalSingleVoteQuery extends CwProposalSingleReactQuery<VoteResponse, TData> {
  args: {
    proposalId: number;
    voter: string;
  };
...
export interface CwProposalSingleProposalCountQuery extends CwProposalSingleReactQuery<ProposalCountResponse, TData> {}
...
export interface CwProposalSingleReverseProposalsQuery extends CwProposalSingleReactQuery<ReverseProposalsResponse, TData> {
  args: {
    limit?: number;
    startBefore?: number;
  };
...
export interface CwProposalSingleListProposalsQuery extends CwProposalSingleReactQuery<ListProposalsResponse, TData> {
  args: {
    limit?: number;
    startAfter?: number;
  };
...
export interface CwProposalSingleProposalQuery extends CwProposalSingleReactQuery<ProposalResponse, TData> {
  args: {
    proposalId: number;
  };
}
...
export interface CwProposalSingleConfigQuery extends CwProposalSingleReactQuery<ConfigResponse, TData> {}
